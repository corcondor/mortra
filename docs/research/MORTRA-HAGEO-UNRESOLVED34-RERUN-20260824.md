...
|---|---|---:|---:|---:|---:|
| `2015IranTSTp18` | right_censored_timeout | 120.0 | - | - | - |
| `2023RMMSLG3` | unsolved | 106.1 | 112 | 339.5 | 902.0 |
| `2024VietnamTSTp5` | unsolved | 62.8 | 112 | 275.9 | 590.5 |
...
|---|---:|---:|---:|---:|
| 3問 x 8候補、上限24 | 600.58 | 8 | 0.799 | 291.63 |
| 3問 x 6候補、上限18 | 600.32 | 6 | 0.600 | 293.15 |

上限18では候補1本の中央値は0.52%遅く、完了候補の処理量は24.97%低下した。
...
- 並列上限A/B: `data/hageo-native-concurrency-ab-2026-08-24.json`
