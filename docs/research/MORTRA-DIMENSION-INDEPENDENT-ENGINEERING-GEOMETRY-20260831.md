...
上記「未実装」はこの実験時点の境界である。同日後続の[工学意味層・12次元セル実行実験](MORTRA-ENGINEERING-SEMANTICS-AND-ND-GENERALIZATION-20260831.md)で、材料、密度、加工法、公差、表面粗さ、基準、接合、力、モーメントを三つの意味形式へ接続した。高次元backendも12次元まで拡張して実行した。完全GD&T、溶接記号、BOM、応力・熱・流体解析は引き続き未実装である。
