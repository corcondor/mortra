...
const CORE_HYPER_MORPHISM_BASIS: readonly HyperMorphismSchema[] = [
  ...
  {
    name: 'CoprimeSegmentReduction',
    sources: ['LinearDiophantineConstraint', 'CoprimeIntegerTuple'],
    target: 'PrimitiveLatticeSegment',
    preserves: ['affine-incidence', 'integrality', 'endpoint-set'],
    backend: ['extended-euclidean-algorithm'],
    allows_cross_parent_fusion: false,
  },
  {
    name: 'LatticePickEvaluation',
    sources: ['LatticePolygonInvariant', 'PrimitiveLatticeSegment'],
    target: 'LatticeInteriorCount',
    preserves: ['area', 'boundary-count', 'integrality', 'both-parent-provenance'],
    backend: ['primitive-triangulation-Euler-certificate', 'exact-lattice-edge-enumeration'],
  },
  {
    name: 'LatticeInteriorCardinality',
    sources: ['LatticeInteriorCount'],
    target: 'Integer',
    preserves: ['value', 'integrality'],
    backend: ['exact-lattice-enumeration'],
    allows_cross_parent_fusion: false,
  },
  {
